...
module.exports = function (schema, options) {
  options = options || {};
  options.saltlen = options.saltlen || 512;
  ...
  options.hashField = options.hashField || 'hashed_password';
  ...
  schema.methods.setPassword = function (password, cb) {
    ...
    crypto.randomBytes(options.saltlen, function (err, buf) {
      ...
      crypto.pbkdf2(password, salt, options.iterations, options.keylen, function (err, hashRaw) {
        ...
        self.set(options.hashField, new Buffer(hashRaw, options.ecoding).toString(options.encoding));
  ...
  schema.methods.authenticate = function (password, cb) {
    ...
    crypto.pbkdf2(password, this.get(options.saltField), options.iterations, options.keylen, function (err, hashRaw) {
      ...
      var hash = new Buffer(hashRaw, options.ecoding).toString(options.encoding);
